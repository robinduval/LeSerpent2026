...
def main(seed=None, manual=False, policy_name="explored64", time_limit_ms=20):
...
def benchmark(seeds, output, max_steps=MAX_SCORE * (BOARD_CELLS - 1),
              policies=("fixed", "explored64"), time_limit_ms=None, workers=1):
...
def cli():
    parser = argparse.ArgumentParser(description="Snake algorithmique : cycle hamiltonien, 2-opt, exploration 64.")
    ...
    parser.add_argument("--policy", default="explored64", help="Politique de la partie affichée.")
    ...
    parser.add_argument("--policies", default="fixed,explored64", help="Politiques comparées, séparées par des virgules.")
